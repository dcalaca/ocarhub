...
async function processarMunicipiosSimples() {
  try {
    console.log('🚀 Processando municípios de forma simples...');
...
if (require.main === module) {
  processarMunicipiosSimples();
}

module.exports = { processarMunicipiosSimples };
