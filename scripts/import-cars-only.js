// Script para importar apenas carros do CSV específico
// Execute: node scripts/import-cars-only.js
...
class CarsOnlyImporter {
  ...
  async run() {
    ...
    if (!csvFile) {
      ...
      console.log('   Uso: node scripts/import-cars-only.js <caminho-do-arquivo.csv>')
      return
    }
...
// Executar
const importer = new CarsOnlyImporter()
importer.run()
