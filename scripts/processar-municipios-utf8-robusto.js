...
async function processarMunicipios() {
  try {
    console.log('🚀 Processando municípios com correção robusta de caracteres...');
    ...
    fs.writeFileSync('municipios-corrigido.csv', correctedContent, 'utf8');
    console.log('💾 Arquivo corrigido salvo como municipios-corrigido.csv');
