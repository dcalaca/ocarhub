// Script específico para importar tabelafipe.csv
// Estrutura: Type,Brand Code,Brand Value,Model Code,Model Value,Year Code,Year Value,Fipe Code,Fuel Letter,Fuel Type,Price,Month
// Execute: node scripts/import-tabelafipe-csv.js
...
class TabelaFipeImporter {
  ...
  async run() {
    ...
    if (!csvFile) {
      ...
      console.log('   Uso: node scripts/import-tabelafipe-csv.js <caminho-do-arquivo.csv>')
      console.log('   Exemplo: node scripts/import-tabelafipe-csv.js "C:\\Users\\dougl\\Downloads\\tabelafipe.csv"')
      return
    }
...
// Executar script
async function main() {
  const importer = new TabelaFipeImporter()
  await importer.run()
}
