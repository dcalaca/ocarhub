...
async function installUltraCleanModels() {
  console.log('🧹 Instalando limpeza ultra agressiva de modelos...\n')

  try {
    // Ler o SQL
    const sql = readFileSync('database/ultra-clean-models.sql', 'utf8')
    ...
    console.log('\n🧹 Esta limpeza ultra agressiva de modelos:')
