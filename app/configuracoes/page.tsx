...
export default function ConfiguracoesPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl content-with-header">
        {/* Cabeçalho */}
        <div className="mb-8">
        ...
        <Tabs defaultValue="notificacoes" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 bg-white/10 backdrop-blur-sm border-white/20">
            <TabsTrigger 
              value="notificacoes" 
              className="data-[state=active]:bg-white/20 data-[state=active]:text-white text-white/80 hover:text-white text-xs md:text-sm"
            >
