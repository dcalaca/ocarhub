        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-gray-600">Verificando variáveis de ambiente...</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="flex items-center space-x-2">
                <span className={`px-2 py-1 rounded text-sm ${
                  ...
                  {envVars?.hasPublicKey ? '✅ Configurada' : '❌ Não configurada'}
                </span>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="flex items-center space-x-2">
                <span className={`px-2 py-1 rounded text-sm ${
                  ...
                  {envVars?.hasAccessToken ? '✅ Configurada' : '❌ Não configurada'}
                </span>
            ...
            <div className="border rounded-lg p-4">
              ...
              <div className="flex items-center space-x-2">
                <span className={`px-2 py-1 rounded text-sm ${
                  ...
                  {envVars?.hasWebhookSecret ? '✅ Configurada' : '❌ Não configurada'}
                </span>
          ...
          {!envVars?.hasPublicKey && (
            <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              ...
              <p className="text-yellow-800 mb-4">
                A variável <code className="bg-yellow-100 px-1 rounded">NEXT_PUBLIC_MP_PUBLIC_KEY</code> não está configurada no Vercel.
              </p>
          ...
          <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <div className="text-blue-800 text-sm space-y-2">
              ...
              <p><strong>3. Vá em Settings → Environment Variables</p>
              <p><strong>4. Adicione as variáveis:</strong></p>
              ...
              <p><strong>6. Faça um novo deploy</strong></p>
            </div>
          </div>
        </div>
      </div>
