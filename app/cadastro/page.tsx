...
import { MailOpenIcon as Envelope, Lock, User, Eye, EyeOff, Loader2, Chrome } from "lucide-react"
...
const CadastroPage = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      setErrors({ email: "Erro ao fazer cadastro com Google. Tente novamente." })
    } finally {
      setLoading(false)
    }
  }
