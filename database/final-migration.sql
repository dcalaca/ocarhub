-- Migração final - limpar tabelas de destino e migrar dados
...
-- 3. Inserir marcas únicas (apenas nome, sem códigos FIPE)
...
-- 4. Inserir modelos únicos (apenas nome base, sem versão)
...
-- 5. Inserir preços (usando modelo completo como versão)
...
-- 6. Marcar registros como processados
