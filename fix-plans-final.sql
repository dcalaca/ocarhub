-- Script para corrigir e garantir os 3 planos corretos
-- Execute este SQL no Supabase SQL Editor

-- 1. Deletar todos os planos de anúncio existentes
DELETE FROM ocar_planos WHERE tipo = 'anuncio';

-- 2. Inserir os 3 planos corretos
...
-- 3. Verificar os planos inseridos
SELECT 
  id,
  nome, 
  tipo, 
